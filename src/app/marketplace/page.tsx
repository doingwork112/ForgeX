    ...
    <div className="relative bg-[#f8f9fa]">
      ...
      <main>
        {/* ══════════════════════════════
            HERO
        ══════════════════════════════ */}
        <section className="relative flex flex-col items-center justify-center px-6 py-10" style={{ minHeight: "calc(100vh - 57px)", background: "#f8f9fa" }}>
          ...
          <div className="relative w-full max-w-4xl grid grid-cols-1 md:grid-cols-2 gap-5">
            {/* LEFT — Developers */}
            <div className="relative flex flex-col rounded-3xl border border-black/[0.07] bg-white p-8 shadow-sm overflow-hidden">
          ...
          {/* Single centered CTA */}
          <button
            onClick={() => gridSectionRef.current?.scrollIntoView({ behavior: "smooth" })}
            className="relative mt-10 inline-flex items-center gap-3 rounded-2xl bg-[#1D9E75] px-10 py-4 text-base font-bold text-white hover:bg-[#178c66] active:scale-[0.98] transition-all shadow-[0_4px_24px_rgba(29,158,117,0.35)]"
          >
            Go to Market
