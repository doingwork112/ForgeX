    ...
    <div className="min-h-screen bg-[#f8f9fa] flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="rounded-2xl border border-black/[0.06] bg-white p-8 shadow-sm">
          {/* Heading */}
          <h1 className="text-2xl font-bold text-[#111] mb-2">Log In</h1>
          ...
          <form onSubmit={handleLogin} className="space-y-3">
            ...
            <div className="flex justify-end">
              <Link href="/auth/forgot-password" className="text-xs font-semibold text-[#1D9E75] hover:underline">
                Forgot password?
              </Link>
            </div>
          ...
          <p className="mt-5 text-sm text-gray-500">
            New to ForgeX?{" "}
            <Link href="/auth/signup" className="font-bold text-[#1D9E75] hover:underline">
              Sign Up
            </Link>
          </p>
        </div>
